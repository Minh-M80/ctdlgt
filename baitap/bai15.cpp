...
// Câu 2. Cài đặt một cấu trúc danh sách liên kết đôi cho kiểu dữ liệu vé máy bay, với các
...
// Câu 3. Chương trình chính: Sử dụng cấu trúc danh sách liên kết đôi và các thao tác ở trên
// để:
...
void listTicketsFromHN(List L) {
    NodePtr temp = L.head;
    cout << "Danh sach ve khoi hanh tu HN:\n";
    while (temp != NULL) {
        if (temp->data.diemKhoiHanh == "HN") {
...
int main(){
    ...
    cout<<"Danh sach may bay khoi hanh tu HN la:"<<endl;
    listTicketsFromHN(L);
    cout<<"========================"<<endl;
